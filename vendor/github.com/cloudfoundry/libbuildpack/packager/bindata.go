...
func srcLanguageGopkgToml() (*asset, error) {
	...
	info := bindataFileInfo{name: "src/LANGUAGE/Gopkg.toml", size: 593, mode: os.FileMode(420), modTime: time.Unix(1565991312, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func srcLanguageIntegration_integration_suite_testGo() (*asset, error) {
	...
	info := bindataFileInfo{name: "src/LANGUAGE/integration/_integration_suite_test.go", size: 4288, mode: os.FileMode(420), modTime: time.Unix(1565991312, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
