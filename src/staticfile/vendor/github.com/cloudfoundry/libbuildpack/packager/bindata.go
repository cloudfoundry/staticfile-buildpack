...
func srcLanguageGopkgToml() (*asset, error) {
	...
	info := bindataFileInfo{name: "src/LANGUAGE/Gopkg.toml", size: 475, mode: os.FileMode(420), modTime: time.Unix(1526054508, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func srcLanguageVendorGitkeep() (*asset, error) {
	...
	info := bindataFileInfo{name: "src/LANGUAGE/vendor/.gitkeep", size: 0, mode: os.FileMode(420), modTime: time.Unix(1526054508, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
